...
var defaultLabel = btn ? btn.textContent : 'Send booking request';
try {
var form = e.target;
...
resetLeadButton(btn, defaultLabel);
alert('Sending failed. Please try again or call 045 187 8083.');
}
return false;
}
...
'</div>' +
'<div class="v-footer">' +
'<div class="v-footer-text">Mansio Group Oy · Business ID 3631044-9 · cleava.fi</div>' +
